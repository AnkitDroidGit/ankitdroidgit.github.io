...
Question 58. [What is the difference between `==` and `===`?](#38-what-is-the-difference-between--and-)
...
`Only initialization, no hoisting happens so trying to read the variable results in ReferenceError exception.`
